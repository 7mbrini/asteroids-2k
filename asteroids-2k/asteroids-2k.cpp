...
)
{
	...
	{
		MessageBox(NULL, _T("Call to RegisterClassEx failed!"), _T(APPNAME), NULL);
	...
	if (!hWnd)
	{
		MessageBox(NULL, _T("Call to CreateWindow failed!"), _T(APPNAME), NULL);
...
* @param	lParam The lParam of the emessage
******************************************************************************/
